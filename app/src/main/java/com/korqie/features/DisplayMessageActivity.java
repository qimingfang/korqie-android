...
public class DisplayMessageActivity extends Activity {
  ...
  public static final String TAG = DisplayMessageActivity.class.getName();

  @InjectView(R.id.display_message_text)
  TextView displayMessageText;
  @InjectView(R.id.imageViewFB)
...
/*
        Request rq = displayLikes();
*/
    Request rq = displayMe();
    System.out.println("This is access token " + Session.getActiveSession().getAccessToken());
//        Request rq = displayUserPhotos();
  ...
  private Request displayMe() {
    Request rq = new Request(Session.getActiveSession(), "/me", null,
            HttpMethod.GET, new Request.Callback() {
      @Override
      public void onCompleted(Response response) {
        try {
          StringBuilder text = new StringBuilder();
          text.append("This is me: \n");
          text.append(response.getGraphObject());
          displayMessageText.setText(text);
          System.out.println(text);
        } catch (Exception e) {
          throw new RuntimeException(e);
